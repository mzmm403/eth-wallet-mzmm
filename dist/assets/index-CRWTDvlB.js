const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomeView-B44Ys_rA.js","assets/el-button-aiRlPCOE.js","assets/el-button-CwY391-e.css","assets/el-input-CwcG6A6c.js","assets/index-D9DVeWaB.js","assets/el-input-CREIi6Ql.css","assets/el-loading-C6RC_sXJ.js","assets/el-loading-x7H6yciF.css","assets/HomeView-DjqKAjQM.css","assets/RegisterView-DS5ROeVK.js","assets/RegisterView-CTeAb9Xj.css","assets/el-message-DJhm0lbD.css","assets/MnemonicView-D48djWr4.js","assets/MnemonicView-Cz1-zSsE.css","assets/CheckView-CpRKyGUo.js","assets/CheckView-BzaZLgwY.css","assets/WalletView-i2493dHq.js","assets/WalletView-CLptyUdv.css"])))=>i.map(i=>d[i]);
...
#define LOW_PRECISION`),e}function AT(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Jp?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Gv?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Wn&&(e="SHADOWMAP_TYPE_VSM"),e}function wT(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Xs:case js:e="ENVMAP_TYPE_CUBE";break;case Na:e="ENVMAP_TYPE_CUBE_UV";break}return e}function RT(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case js:e="ENVMAP_MODE_REFRACTION";break}return e}function CT(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Qp:e="ENVMAP_BLENDING_MULTIPLY";break;case m0:e="ENVMAP_BLENDING_MIX";break;case g0:e="ENVMAP_BLENDING_ADD";break}return e}function PT(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function LT(n,e,t,i){const s=n.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=AT(t),l=wT(t),u=RT(t),f=CT(t),h=PT(t),d=xT(t),g=vT(r),_=s.createProgram();let m,p,E=t.glslVersion?"#version "+t.glslVersion+`
